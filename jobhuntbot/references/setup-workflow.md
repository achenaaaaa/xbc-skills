...
The dashboard is the system memory.
...
## Chinese Campus Recruitment (中国秋招) Specific Notes

When the user's target is Chinese state-owned enterprises / campus recruitment:

- Primary job boards: company official campus portal, 国聘网 (iguopin.com), 应届生求职网 (yingjiesheng.com)
- Cycle: 秋招 (Sep-Nov), 春招 (Mar-May), 提前批 (Jun-Aug)
- Target graduating class: ask the user (typically "2027届" for 2027 graduation)
- Watch for mixed postings: intern vs. full-time, 秋招 vs. 春招 vs. 社招
- State-owned enterprises often have strict per-person submission limits
- Application forms tend to be custom portals, not standard ATS (no Greenhouse/Lever/Workday)
- Common required materials: 学籍验证报告, 成绩单, 四六级成绩, 党员身份等
